...
import { dmSerifSans, inter, oswald, storyScript } from "@/lib/fonts";
    ...
    <section id="home" className="h-full bg-[#f7f6f2] bg-[url('/pattern.svg')] bg-center bg-no-repeat bg-cover flex flex-col items-center pt-28">
      <div className="flex flex-col items-center gap-6 px-4 w-full max-w-4xl h-[70vh] justify-center">
        ...
        <div className="flex items-center gap-2 bg-white rounded-md px-2 py-1 shadow-sm border border-black/5">
          <span className="text-sm font-semibold bg-gradient-to-r from-[#f9c6b3] to-[#fceae3] text-[#d45531] px-1 rounded-md">
            Hey!
          </span>
