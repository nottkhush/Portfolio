  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl items-center px-6">
        ...
        {/* TEXT CONTENT */}
        <div className="px-6">
          <h2 className={`${dmSerifSans.className} text-7xl font-bold mb-15`}>
            About Me
          </h2>
          <p className="text-lg text-gray-700 mb-4">
            Hello! I&apos;m Khushal Jain, a passionate web developer with a
          ...
          <p className="text-lg text-gray-700">
            ...
            love for photography. Let&apos;s connect and create something
            amazing together!
          </p>
        </div>
      </div>
